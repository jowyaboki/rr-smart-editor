    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        >
          ...
          >
            <div>
              Total Clips: <strong style={{ color: '#fff' }}>{originalClipsCount}</strong>
            </div>
            <div>
              Total Tracks: <strong style={{ color: '#fff' }}>{originalTracksCount}</strong>
            </div>
            <div>
              Database Integrity: <strong style={{ color: '#4caf50' }}>Synchronized</strong>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <p style={{ margin: '0 0 10px 0', fontSize: '13px', color: '#ccc' }}>
            ...
            <span style={{ color: '#fff', fontWeight: 'bold' }}>
              {simulatedProject.name} (Simulated)
            </span>
          </p>
          <div
            style={{
          ...
          >
            <div>
              Total Clips: <strong style={{ color: '#fff' }}>{simulatedClipsCount}</strong>
            </div>
            <div>
              Total Tracks: <strong style={{ color: '#fff' }}>{simulatedTracksCount}</strong>
            </div>
            <div>
              Database Integrity:{' '}
              <strong style={{ color: '#2196f3' }}>Simulated Isolated Cache</strong>
            </div>
          </div>
        </div>
      </div>
