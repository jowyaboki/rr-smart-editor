...
export const lightTheme: Theme = {
  ...
  tokens: {
    ...
    shadows: {
      ...
      low: {
        key: 'shadows.low',
        value: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.12)',
        type: 'elevation',
      },
      medium: {
        key: 'shadows.medium',
        value: '0 3px 6px rgba(0,0,0,0.10), 0 3px 6px rgba(0,0,0,0.15)',
        type: 'elevation',
      },
    },
    opacity: defaultOpacity,
  ...
  tokens: {
    colors: {
      primary: {
        ...
        value: '#8b5cf6',
        type: 'color',
        description: 'Purple brand primary',
      },
      secondary: {
        key: 'colors.secondary',
        value: '#ec4899',
        type: 'color',
        description: 'Pink brand secondary',
      },
    },
  },
};
