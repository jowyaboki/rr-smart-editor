  ...
  return (
    ...
    >
      ...
      >
        {isDebugging ? (
          <div>
            <span style={{ color: '#ff9800' }}>[PAUSED]</span> Breakpoint hit at node ID:{' '}
            <strong style={{ color: '#fff' }}>{activeStepNodeId}</strong>.
            <div style={{ marginTop: '4px', color: '#888' }}>
              Click "Step Forward" to execute node and advance.
            </div>
          </div>
        ) : (
          <div style={{ color: '#444', textAlign: 'center', marginTop: '25px' }}>
