    ...
    >
      ...
      >
        <h3 style={{ margin: 0, fontSize: '16px', color: '#2196f3' }}>
          🧩 Parallel Shard Monitor (Frame Sharding)
        </h3>
      ...
      {shards.length === 0 ? (
        ...
        >
          No active frame-sharded tasks currently rendering. Set frame count to generate
          assignments.
        </div>
      ) : (
            ...
            {shards.map((shard) => (
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  ...
                  >
                    <span>
                      Frames {shard.startFrame} - {shard.endFrame}
                    </span>
