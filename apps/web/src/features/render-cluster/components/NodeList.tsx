            ...
            >
              <div>
                ...
                <div style={{ fontSize: '11px', color: '#aaa', marginTop: '4px' }}>
                  ID: {node.id} | Type:{' '}
                  <span style={{ textTransform: 'uppercase' }}>{node.provider}</span> |{' '}
                  {node.capabilities.coresCount} Cores | {node.capabilities.memoryGb}GB RAM
                </div>
              </div>
            ...
            >
              <div>
                ...
                >
                  <div
                    style={{
                      width: `${node.telemetry.cpuUsagePercent}%`,
                      height: '100%',
                      background: '#4caf50',
                    }}
                  />
              ...
              <div>
                ...
                >
                  <span>GPU Usage</span>
                  <strong>
                    {node.capabilities.gpuEnabled
                      ? `${node.telemetry.gpuUsagePercent || 0}%`
                      : 'N/A'}
                  </strong>
                </div>
                <div
                ...
                >
                  <div
                    style={{
                      width: `${node.capabilities.gpuEnabled ? node.telemetry.gpuUsagePercent || 0 : 0}%`,
                      height: '100%',
                      background: '#2196f3',
                    }}
                  />
