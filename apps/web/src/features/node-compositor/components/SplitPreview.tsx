  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <span style={{ fontSize: '10px', background: '#3b82f620', color: '#3b82f6', padding: '2px 6px', borderRadius: '4px' }}>
      ...
      <div style={{
        ...
        {viewMode === 'preview' ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: `${splitRatio * 100}% ${(1 - splitRatio) * 100}%`, width: '100%', height: '100%' }}>
            <div style={{ backgroundColor: '#252529', borderRight: '1px solid #ef4444', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', color: '#888' }}>
              RAW SOURCE (A)
            </div>
            <div style={{ backgroundColor: '#101015', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', color: '#10b981' }}>
              KEYED PLATE (B)
            </div>
          </div>
        ) : viewMode === 'diff' ? (
