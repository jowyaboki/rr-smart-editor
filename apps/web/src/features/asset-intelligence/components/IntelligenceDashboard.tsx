    ...
    >
      ...
      <div style={{ marginBottom: '24px', borderBottom: '1px solid #222', paddingBottom: '16px' }}>
        ...
        <p style={{ margin: '4px 0 0 0', fontSize: '14px', color: '#aaa' }}>
          Cognitive semantic search indexing, vision concept extractions, speech transcribing,
          content safety checks, and smart suggestions.
        </p>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          {activeAsset ? (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <div>
                  ...
                  <code style={{ fontSize: '12px', color: '#2196f3', wordBreak: 'break-all' }}>
                    {activeAsset.url}
                  </code>
                </div>

                {activeAsset.metadata.aiGeneratedTags &&
                  activeAsset.metadata.aiGeneratedTags.length > 0 && (
                    <div>
                      <div
                        style={{
                          fontSize: '11px',
            ...
            >
              ...
              Select any asset file from search panel to display the AI cognitive inspector,
              recommendations, and quality audits.
            </div>
          )}
