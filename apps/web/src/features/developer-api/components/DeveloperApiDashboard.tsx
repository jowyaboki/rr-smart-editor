...
import { ApiKey, Webhook, WebhookEvent } from '@ai-video-editor/api-gateway';
...
export const DeveloperApiDashboard: React.FC = () => {
  const {
    apiKeys,
    webhooks,
    webhookEvents,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: '16px', fontWeight: 'bold', color: '#fff' }}>
              ENTERPRISE API GATEWAY, INTEGRATION HUB & PUBLIC SDK
            </h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr 340px', overflow: 'hidden' }}>
        ...
        >
          ...
          <div style={{ borderTop: '1px solid #2d2d2d', paddingTop: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              {(['playground', 'keys', 'webhooks', 'documentation'] as const).map((p) => (
                <div
                  key={p}
...
export default DeveloperApiDashboard;
