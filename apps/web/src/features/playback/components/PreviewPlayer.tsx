...
export const PreviewPlayer: React.FC<PreviewPlayerProps> = ({ timelineClips = [] }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ fontSize: '14px', fontWeight: 'bold', color: '#8b5cf6', marginBottom: '8px' }}
        >
        ...
        >
          Active Video Tracks:{' '}
          {Math.abs(Math.sin(currentFrame * 0.1)) > 0.5
            ? '🟢 Render Normal'
          ...
          <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
            ...
            <button
              ...
              style={{
                padding: '2px 6px',
                fontSize: '10px',
                backgroundColor: settings.quality === 'low' ? '#3b82f6' : '#1e293b',
                border: 'none',
                color: '#fff',
                borderRadius: '2px',
                cursor: 'pointer',
            ...
            <button
              ...
              style={{
                padding: '2px 6px',
                fontSize: '10px',
                backgroundColor: settings.quality === 'high' ? '#3b82f6' : '#1e293b',
                border: 'none',
                color: '#fff',
                borderRadius: '2px',
                cursor: 'pointer',
            ...
            {[-1.0, 1.0, 2.0, 4.0].map((rate) => (
              <button
                ...
                style={{
                  padding: '2px 6px',
                  fontSize: '10px',
                  backgroundColor: settings.playbackRate === rate ? '#3b82f6' : '#1e293b',
                  border: 'none',
                  color: '#fff',
                  borderRadius: '2px',
                  cursor: 'pointer',
              ...
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...
                    playbackRate: e.target.checked ? -1.0 : 1.0,
                  })
                }
              />
              Reverse Play
      ...
      <div style={{ borderTop: '1px solid #1e293b', paddingTop: '16px' }}>
        <h4 style={{ margin: '0 0 8px 0', fontSize: '13px', color: '#b2bac2' }}>
        ...
        >
          <div>
            Evaluation Latency: <strong>{metrics.evaluationLatencyMs.toFixed(1)}ms</strong>
          </div>
          <div>
            Pre-Buffer utilization: <strong>{metrics.bufferUtilization}%</strong>
          </div>
          <div>
            Dropped Frames:{' '}
            <strong style={{ color: metrics.droppedFramesCount > 0 ? '#ef5350' : '#10b981' }}>
