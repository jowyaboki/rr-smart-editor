    ...
    >
      ...
      <div style={{ borderTop: '1px solid #2d2d2d', paddingTop: '16px' }}>
        ...
        <div style={{ fontSize: '13px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div>
            Heading Font: <strong style={{ color: '#fff' }}>{theme.typography.headingFont}</strong>
          </div>
          <div>
            Body/Text Font: <strong style={{ color: '#fff' }}>{theme.typography.bodyFont}</strong>
          </div>
          <div>
            Caption/Meta Font:{' '}
            <strong style={{ color: '#fff' }}>{theme.typography.captionFont}</strong>
          </div>
        </div>
      </div>
      ...
      <div style={{ borderTop: '1px solid #2d2d2d', paddingTop: '16px', marginTop: '16px' }}>
        ...
        <div style={{ fontSize: '13px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div>
            Minimum Width: <strong style={{ color: '#fff' }}>{logos.rules.minWidthPx}px</strong>
          </div>
          <div>
            Preferred Region:{' '}
            <strong style={{ color: '#fff', textTransform: 'capitalize' }}>
              {logos.rules.preferredPlacement.replace('_', ' ')}
            </strong>
          </div>
        </div>
      </div>
