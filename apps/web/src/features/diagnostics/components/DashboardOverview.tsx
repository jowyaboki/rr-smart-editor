...
export const DashboardOverview: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <span
          style={{ fontSize: '11px', fontWeight: 'bold', display: 'block', marginBottom: '6px' }}
        >
          Active Developer Warnings
        </span>
        {alerts.length === 0 ? (
          <div style={{ color: '#666', fontSize: '10px', padding: '4px 0' }}>
            No active alerts. Telemetry normal.
          </div>
        ) : (
