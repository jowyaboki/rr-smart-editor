...
export const LiveSwitcher: React.FC = () => {
  const { activeScenes, switcherState, selectPreview, cut, fade, wipe, stinger } =
    useBroadcastStore();
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
        ...
        >
          ...
          >
            ...
            <span>
              {previewScene
                ? `${previewScene.name} (Inputs: ${previewScene.inputs.length})`
                : 'Black Out'}
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div
            style={{
              ...
              flexDirection: 'column',
              gap: '8px',
              animation: switcherState.isTransitioning ? 'pulse 0.5s infinite alternate' : 'none',
            }}
          >
