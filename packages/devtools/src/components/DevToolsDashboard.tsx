...
export const DevToolsDashboard: React.FC<DevToolsDashboardProps> = ({
  initialPanel = 'plugins',
}) => {
  const [activeTab, setTab] = useState<string>(initialPanel);
  const [breakpoints, setBreakpoints] = useState<string[]>([
    'st_2_cycle_detect_on',
    'expr_pollute_block',
  ]);
        ...
        return (
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#ccc' }}>
              Inspect active registration lifecycle states and permission scopes for mock plugins.
            </p>
            <div
              style={{
                background: '#151515',
      ...
      case 'workflows':
        return (
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#ccc' }}>
              Trace automatic execution flows, pause on node errors, or inspect variables state.
            </p>
      ...
      case 'agents':
        return (
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#ccc' }}>
              Inspect LLM system prompts, token usage, and local Ollama/Whisper endpoints.
            </p>
            <div
              style={{
                background: '#252526',
            ...
            >
              <div>
                Active Model: <strong>llama3 (Ollama)</strong>
              </div>
      ...
      case 'render':
        return (
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#ccc' }}>
              Real-time telemetry of parallel frame chunks, GPU decodes, and node health.
            </p>
            <div
              style={{
                background: '#252526',
            ...
            >
              <div>
                Throughput: <strong>144 FPS</strong>
              </div>
              <div style={{ color: '#4caf50', marginTop: '4px' }}>
                GPU: NVIDIA RTX 4090 (CUDA Active)
              </div>
            </div>
          </div>
        );
      case 'timeline':
        return (
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#ccc' }}>
              Inspect clip movement delta offsets, snapping coordinates, and virtual geometry
              caches.
            </p>
            <div
              style={{
            ...
            >
              <div>
                Grid Snapping: <strong>8 frames (Enabled)</strong>
              </div>
            </div>
          </div>
        );
      case 'expressions':
        return (
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#ccc' }}>
              Inspect parsed AST tree logs, resolve dependency graphs, and evaluate prototype
              pollution guards.
            </p>
            <div
              style={{
            ...
            >
              🚨 Prototype pollution blocked for expression payload: "this.__proto__.polluted =
              true"
            </div>
          </div>
        );
