export * from '@ai-video-editor/api-platform';
...
export class SDKGenerationService {
  public generateTypeScriptSDK(): string {
    return `// Dynamic generated TS SDK`;
  }
  public generatePythonSDK(): string {
    return `# Dynamic generated Python SDK`;
  }
  public generateGoSDK(): string {
    return `// Dynamic generated Go SDK`;
  }
}

export const globalSDKGenerationService = new SDKGenerationService();
