...
export class TemplateService {
  ...
  public loadChromaKeyTemplate(graphId: string): NodeGraph {
    const inputMediaNode: Node = {
      ...
      inputs: [],
      outputs: [{ id: 'port_raw_out_1', name: 'image', direction: 'output', type: 'image' }],
    ...
    const keyingNode: Node = {
      ...
      outputs: [{ id: 'port_mask_out_1', name: 'mask', direction: 'output', type: 'mask' }],
    ...
    const blurNode: Node = {
      ...
      outputs: [{ id: 'port_blur_out_1', name: 'image', direction: 'output', type: 'mask' }],
      properties: { radius: 8 },
    };
    ...
    const backgroundNode: Node = {
      ...
      inputs: [],
      outputs: [{ id: 'port_bg_out_1', name: 'image', direction: 'output', type: 'image' }],
    ...
    const mergeNode: Node = {
      ...
      outputs: [{ id: 'port_merge_out_1', name: 'image', direction: 'output', type: 'image' }],
    ...
    const renderOutputNode: Node = {
      ...
      inputs: [{ id: 'port_render_in_1', name: 'input', direction: 'input', type: 'image' }],
      outputs: [],
    ...
    return {
      ...
      connections: [
        {
          id: 'c1',
          fromNodeId: 'node_media_input_1',
          fromPortId: 'port_raw_out_1',
          toNodeId: 'node_keyer_1',
          toPortId: 'port_key_in_1',
        },
        {
          id: 'c2',
          fromNodeId: 'node_keyer_1',
          fromPortId: 'port_mask_out_1',
          toNodeId: 'node_mask_blur_1',
          toPortId: 'port_blur_in_1',
        },
        {
          id: 'c3',
          fromNodeId: 'node_media_input_1',
          fromPortId: 'port_raw_out_1',
          toNodeId: 'node_comp_merge_1',
          toPortId: 'port_merge_fg_1',
        },
        {
          id: 'c4',
          fromNodeId: 'node_bg_img_1',
          fromPortId: 'port_bg_out_1',
          toNodeId: 'node_comp_merge_1',
          toPortId: 'port_merge_bg_1',
        },
        {
          id: 'c5',
          fromNodeId: 'node_mask_blur_1',
          fromPortId: 'port_blur_out_1',
          toNodeId: 'node_comp_merge_1',
          toPortId: 'port_merge_mask_1',
        },
        {
          id: 'c6',
          fromNodeId: 'node_comp_merge_1',
          fromPortId: 'port_merge_out_1',
          toNodeId: 'node_render_terminal_1',
          toPortId: 'port_render_in_1',
        },
      ],
      groups: [],
      bookmarks: [
