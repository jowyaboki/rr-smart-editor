...
class RenderPluginRegistry {
  ...
  registerPreset(preset: RenderPreset) {
  ...
  registerExportFormat(format: ExportFormat) {
  ...
  registerPostProcessingStep(step: PostProcessingStep) {
...
export const renderPluginRegistry = new RenderPluginRegistry();
